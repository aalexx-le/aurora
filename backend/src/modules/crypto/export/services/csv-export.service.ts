...
export class CsvExportService {
    ...
    private generateCsvContent(data: PortfolioExportData): string {
        ...
        lines.push(
            "Total Investment," + this.formatCurrency(data.totalInvestment),
        );
        ...
        lines.push(
            "Profit Percentage," + this.formatPercentage(data.profitPercentage),
        );
        ...
        lines.push(
            "Symbol,Investment,Current Price,Quantity,Current Value,Profit,Profit %,Category,Exchange",
        );
        ...
        lines.push(
            "Category,Investment,Current Value,Profit,Profit %,Asset Count,Allocation %",
        );
